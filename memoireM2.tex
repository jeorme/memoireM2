...
\right)
$$
Les 3 premières autocrrélations partiel
les sont donc déterminées par les relation suivantes~:
\begin{align*}
r(1)&=\rho(1)\\
...
\end{align*}
Les processus ARCH(q) sont des processus dit \textit{fat tail} car la valeur de la kurtosis est supérieur à celle d'une loi normale. C'est souvent le cas pour des données financières.
